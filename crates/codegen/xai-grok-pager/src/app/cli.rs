...
#[command(
    ...
    about = "DSpark TUI — creator drafts, curator audits (default workflow)",
...
impl PagerArgs {
    ...
    pub fn parse_cli() -> Self {
        let bin_name = std::env::args()
            ...
            .filter(|n| matches!(n.as_str(), "grok" | "agent" | "dspark-cli" | "dspark"))
            .unwrap_or_else(|| "dspark-cli".to_owned());
