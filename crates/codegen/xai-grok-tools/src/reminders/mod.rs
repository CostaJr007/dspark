...
//! - [`LspDiagnosticsReminder`], [`SkillDiscoveryReminder`], [`TaskCompletionReminder`], [`DsparkCurateReminder`]
//!
//! All reminders are collected and appended in `call_new_tool()`.

pub mod dspark_curate;
pub mod lsp_diagnostics;
pub mod skill_discovery;
pub mod task_completion;

pub use dspark_curate::DsparkCurateReminder;
