...
impl ThemeKind {
    ...
    pub fn from_name(name: &str) -> Option<Self> {
        ...
        match lower.as_str() {
            ...
            "bloomberg" | "bbg" | "amber" => Some(Self::Bloomberg),
            _ => None,
        }
    }
...
impl Theme {
    ...
    pub fn current() -> Self {
        ...
        let base = match cache::current_kind() {
            ...
            ThemeKind::Bloomberg => Self::bloomberg(),
...
mod tests {
    ...
    fn is_auto_returns_false_for_concrete_variants() {
        ...
        assert!(!ThemeKind::Bloomberg.is_auto());
    }
    ...
    fn is_dark_classifies_built_in_themes() {
        ...
        assert!(Theme::bloomberg().is_dark());
    ...
    fn scrollbar_thumb_contrasts_with_track_in_all_themes() {
        ...
        for &kind in ThemeKind::ALL {
            let theme = match kind {
                ...
                ThemeKind::Bloomberg => Theme::bloomberg(),
    ...
    fn from_name_concrete_variants_still_work() {
        ...
        assert_eq!(ThemeKind::from_name("bloomberg"), Some(ThemeKind::Bloomberg));
        assert_eq!(ThemeKind::from_name("amber"), Some(ThemeKind::Bloomberg));
        assert_eq!(ThemeKind::from_name("bbg"), Some(ThemeKind::Bloomberg));
    }
